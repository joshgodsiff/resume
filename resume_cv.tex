...
\name{Joshua}{Korner-Godsiff}
\address{12/19 Crane St, Homebush, NSW, Australia, 2140}
\mobile{0408 125 562}

\email{josh.godsiff@gmail.com}
% \homepage{www.posquit0.com}
\github{joshgodsiff}
\linkedin{joshgodsiff}
%\skype{skypeid}
...
% \quote{``I will replace you with a very small bash script."} % A quote or statement

\makecvfooter{\today}{Joshua Korner-Godsiff~~~·~~~Résumé}{\thepage} % Specify the letter footer with 3 arguments: (<left>, <center>, <right>), leave any of these blank if they are not needed
...
\input{cv-sections/community.tex}
